...
export class ChatServerStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    chatSg.addIngressRule(Peer.anyIpv4(), Port.tcp(80));

    chatSg.addIngressRule(Peer.anyIpv4(), Port.tcp(22));
    ...
    const chatSGUserData = readFileSync(
      "./assets/configure_ubuntu_linux_chat_app.sh",
      "utf-8"
    );
